      ...
      <div class="folha" id="fichaFolha">
        ...
        <div class="folha-topo">
          ...
          <div class="folha-info">
            ...
            <div>Representante: <b>${esc(dados.usuario || "—")}</b>${dados.boardName ? " · " + esc(dados.boardName) : ""}</div>
          </div>
        </div>
        ...
        <div class="fi-secao">
          ...
          <div class="fi-grade">
            ${linhaFicha("Nome fantasia", card.nome)}
            ${linhaFicha("Razão social", card.razaoSocial)}
            ${linhaFicha("CNPJ", card.cnpj)}
            ${linhaFicha("Inscrição estadual", card.inscricaoEstadual)}
            ${linhaFicha("Responsável", card.responsavelEmpresa)}
          </div>
        </div>
        ...
        <div class="fi-secao">
          ...
          <div class="fi-grade">
            ${linhaFicha("Banco", card.banco)}
            ${linhaFicha("Agência", card.agencia)}
            ${linhaFicha("Conta corrente", card.contaCorrente)}
            ${linhaFicha("Conta poupança", card.contaPoupanca)}
            ${linhaFicha("Pix", card.pix)}
          </div>
        </div>` : ""}
