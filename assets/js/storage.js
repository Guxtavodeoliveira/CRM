...
function cardPadrao(){
  return {
    ...
    nome: "", cnpj: "", razaoSocial: "", inscricaoEstadual: "",
    responsavelEmpresa: "", descricao: "",
    // dados bancários do cliente
    banco: "", agencia: "", contaCorrente: "", contaPoupanca: "", pix: "",
    // campos antigos: ficam só para não quebrar arquivos já salvos
    categoria: "", origem: "", responsavel: "", setor: "",
...
function normalizar(raw){
  ...
  d.cards = d.cards.map(c => {
    ...
    // "Responsável" mudou de sentido: antes era o vendedor, agora é quem
    // responde pela empresa. Aproveita o que já estava escrito.
    if(!card.responsavelEmpresa && card.responsavel && card.responsavel !== (d.usuario || "Eu")){
      card.responsavelEmpresa = card.responsavel;
    }
